  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="flex flex-col gap-6">
        {users.map((user: User) => {
          return (
            <div className=" bg-blue-500 rounded-l-full rounded-r-full shadow-md my-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="flex flex-row gap-2 pt-1">
                        {user.interests.map((interest: string) => {
                          return (
                            <div className=" text-lg rounded-md w-full text-blue-500 px-2 bg-white font-semibold whitespace-nowrap">
                              {interest}
                            </div>
                          );
                        })}
